...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<diff-lcs>.freeze, ["~> 1.2.5"])
      s.add_runtime_dependency(%q<concord>.freeze, ["~> 0.1.5"])
      s.add_runtime_dependency(%q<parser>.freeze, ["~> 2.3.0"])
      ...
      s.add_dependency(%q<diff-lcs>.freeze, ["~> 1.2.5"])
      s.add_dependency(%q<concord>.freeze, ["~> 0.1.5"])
      s.add_dependency(%q<parser>.freeze, ["~> 2.3.0"])
